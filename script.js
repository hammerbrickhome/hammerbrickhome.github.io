...
/* ---------------------------
   ✅ Chat bubble toggle (Esc key closes)
---------------------------- */
...
function filterServices() {
  ...
  document.querySelectorAll('.service-grid .card, .service-grid .service-button').forEach(card => {
...
/* ============================================================
   ✅ GALLERY PAGE — LOAD gallery.json (Grid & Pairs)
=============================================================== */
async function loadGalleryPage() {
  ...
  try {
    ...
    function renderMorePairs() {
      ...
      if (compareRow && shuffledPairs.length === 0)
        compareRow.innerHTML = '<p>No before/after pairs found.</p>';
    }
...
/* ============================================================
   ✅ HOMEPAGE — BEFORE & AFTER (images.json)
=============================================================== */
...
function renderNextSix() {
  ...
  if (BA_LOADMORE && baIndex >= allPairs.length)
